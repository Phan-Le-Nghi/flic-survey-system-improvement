...
function renderLayout(pageId, pageTitle, contentHTML) {
  ...
  const headerAvatarHtml = avatarSrc
    ...
    : `<div id="header-user-avatar" class="avatar-initials" style="background:#0250AD;width:100%;height:100%;font-size:14px;display:flex;align-items:center;justify-content:center;color:#fff;border-radius:50%;font-weight:600">${initials}</div>`;
...
const _bellIcon = {
  info:    `<svg viewBox="0 0 24 24" fill="none" stroke="#0250AD" stroke-width="2" width="18" height="18"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>`,
