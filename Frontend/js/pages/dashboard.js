...
function ensureDashboardStyle() {
  ...
  document.getElementById('page-content').insertAdjacentHTML('beforebegin', `
    <style id="dashboard-polish-style">
      #page-content {
        background:
          radial-gradient(circle at 12% 4%, rgba(0, 0, 139, .08), transparent 28%),
          radial-gradient(circle at 90% 12%, rgba(16, 185, 129, .08), transparent 30%),
          linear-gradient(180deg, #f8fbff 0%, #f6f9fd 52%, #ffffff 100%);
        padding: 18px;
        border-radius: 26px;
      }
      ...
      .dash-shell .page-title { color:#0f172a; font-size:34px; line-height:1; margin-bottom:8px; }
      .dash-shell .page-sub { color:#64748b; font-size:14px; max-width:620px; }
      ...
      .dash-shell .stat-card { min-height:132px; padding:20px; background:rgba(255,255,255,.96); }
      .dash-shell .stat-label { color:#64748b; font-size:13px; font-weight:700; }
      .dash-shell .stat-value { color:#0f172a; font-size:34px; margin-top:8px; }
      ...
      .dash-chart-wrap { height:320px !important; padding:10px 4px 0; border-radius:18px; background:linear-gradient(180deg,rgba(248,250,252,.65),rgba(255,255,255,0)); }
      .dash-shell .section-title { color:#0f172a; font-size:18px; font-weight:800; }
      .dash-shell .section-sub { color:#64748b; font-size:12.5px; margin-top:4px; }
    ...
    <div class="dash-shell">
      ...
      <div class="dash-top-grid">
        ...
        <div class="card" style="overflow:hidden;display:flex;flex-direction:column">
          <div style="background:#00008B;padding:10px 14px;display:flex;align-items:center;justify-content:space-between">
