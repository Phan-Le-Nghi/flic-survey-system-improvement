...
document.getElementById("page-content").innerHTML = `
  ...
  <div class="card card-body" style="margin-bottom:16px">
    <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap">
      ...
      <select id="fav-cat-filter" class="input" style="width:200px;background:#f8f9fb" onchange="applyFilters()">
  ...
  <div id="fav-pagination" style="display:none;background:#fff;border:1px solid var(--gray-200);border-radius:var(--radius-lg);padding:12px 18px;align-items:center;justify-content:space-between;margin-top:16px;box-shadow:var(--shadow-sm)">
    ...
    <div class="form-card">
      <div class="form-card-thumb">
        ...
        <div style="position:absolute;top:10px;right:10px">
          <button type="button" style="width:32px;height:32px;border-radius:50%;background:rgba(255,255,255,.95);display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(0,0,0,.18);border:none;cursor:pointer" onclick="removeFavorite('${form.id}')" title="Bỏ yêu thích">
      ...
      <div class="form-card-body">
        ...
        <div style="display:flex;gap:8px;margin-top:14px">
          ...
          <button class="btn btn-outline btn-sm" style="flex:1;justify-content:center;border-color:#fecaca;color:#b91c1c;background:#fff" onclick="removeFavorite('${form.id}')">Bỏ yêu thích</button>
        </div>
      </div>
    </div>
  `).join("");
